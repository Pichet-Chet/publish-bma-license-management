...
namespace bma_license_api.Controllers
{
    ...
    {
        private readonly ISysUserPermissionService _service;

        public SysUserPermissionController(ISysUserPermissionService service)
        {
            _service = service;
        }

        [HttpGet]
        public async Task<IActionResult> GetFilter([FromQuery] GetSysUserPermissionFilterRequest param)
        {
