...
namespace bma_license_api.Controllers
{
    ...
    [ApiController]
    public class SysUserTypeController : ControllerBase
    {
        private readonly ISysUserTypeService _service;
        public SysUserTypeController(ISysUserTypeService service)
        {
            _service = service;
        }
        [HttpGet]
        public async Task<IActionResult> GetFilter([FromQuery] GetSysUserTypeFilterRequest param)
        {
